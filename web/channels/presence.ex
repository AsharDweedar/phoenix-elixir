defmodule Helloworld.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Helloworld.MyChannel do
        use HelloworldWeb, :channel
        alias Helloworld.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :helloworld,
